...
class ProductController extends Controller
{
    ...
    public function createNoVariant(Request $request)
    {
        ...
        {   
            ...
            $request->product_image->storeAs('/public/storage_images/products/', $imageName);
        }
    ...
    {   
        ...
        if ($request->hasFile('product_image') && $request->filled('product_image'))
        {
            ...
            Storage::delete('/public/storage_images/products/'.$old_image);
        }
    ...
    public function destroy(Product $product)
    {
        ...
        if ($product->delete())
        {
            Storage::delete('/public/storage_images/products/'.$imageName);
