...
class InventoryController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        else
        {
            ...
            $inventory = Inventory::with('product.category','inventoryVariant.productWithVariant')->paginate(10);
        }
    ...
    {
    	$request->validate([
    		'inventory_stocl' => 'required|numeric'
    	]);
        ...
        $array_params = [
            'id' => $request->admin_id,
            'action' => 'Added stock(s). Inventory no.: '.$inventory->number.', Old stock: '.$old_stock.' New stock: '.$inventory->inventory_stock,
        ];
