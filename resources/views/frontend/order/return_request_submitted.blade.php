...
<div class="container">
	<div class="row">
		<div class="col-12">
			<center>
				<h3 style="font-weight: bolder; font-size: 40px; margin-top: 100px;" class="mb-2"><i class="fa fa-check-circle text-success"></i>&nbsp;Your return request has been submitted.</h3>
