...
This is your approved cancellation notification for your cancellation request on {{$cancellation->date_request }}, Order Number {{$cancellation->order_number}} placed on {{$cancellation->order->order_created}}.
