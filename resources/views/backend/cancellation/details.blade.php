		...
		<div class="card mb-5">
			<div class="card-body">
				<div class="mb-3 clearfix">
					<h2 class="float-left">Cancellation Details</h2>
				</div><!-- div clearfix-->
				<div class="mb-5 pt-3">
			...
			<div class="card-footer">
				<div class="float-right">
						...
						<a href="{{route('cancellation_decline_form', ['cancellation'=>$cancellation->id])}}" class="btn btn-danger float-right">Decline</a>
						<form method="POST" class="float-right mr-2" action="{{route('approve_cancellation')}}">
							{{csrf_field()}}
							{{method_field('PUT')}}
