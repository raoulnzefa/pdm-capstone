					...
					<table class="table order-table">
						...
						<tr>
		                    ...
		                    <span class="badge badge-primary" style="font-size: 16px;" v-if="order.order_status == 'Processing'">{{ order.order_status }}</span>
		                     <span class="badge badge-for-shipping" style="font-size: 16px;" v-if="order.order_status == 'For shipping'">{{ order.order_status }}</span>
		                    <span class="badge badge-for-shipped" style="font-size: 16px;" v-if="order.order_status == 'Shipped'">{{ order.order_status }}</span>
