              ...
              <div>
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <template v-else>
                      <template v-if="!orders_for_delivery.length">
                        <tr>
                          <td colspan="10" align="center">
                      ...
                      <template v-else>
                        <tr v-for="(order, index) in orders_for_delivery" :key="index">
...
<script>
  ...
  export default {
    ...
    methods: {
      getOrdersByDelivery() {
        this.loading = true;
        axios.get('/api/orders/delivery/get')
        .then(res => {
          this.orders_for_delivery = res.data;
          this.loading = false;
        })
        .catch(err => {
          this.loading = false;
